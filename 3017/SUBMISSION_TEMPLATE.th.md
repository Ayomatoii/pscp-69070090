...
```text
รับ input เป็นราคาหาร+เครื่องดื่ม และหาค่าบริการ 10% พร้อมตั้งเงื่อนไขสำหรับค่าบริการว่าไม่น้อยกว่า 50 และไม่เกิน 1000 บาท และค่อยมาคิดค่า vat 7% จากนั้น output ออกมาโดยการรวมราคาทั้งสามอย่างและปัดเศษทศนิยม 2 ตำแหน่ง 
```
...
Step 2:คิดค่าบริการ
Step 3:คิดค่า vat หลังจากรวมค่าอาหารและค่าบริการแล้ว
Step 4:Output ทุกค่ารวมกัน
```
...
```text
เพราะบางคนคิด vat โดยที่ยังไม่ได้คิดค่าบริการเข้าไปด้วย
```
...
```text
เพราะบางคนลืมเงื่อนไขว่าค่าบริการขั้นต่ำต้อง 50 แต่ไม่เกิน 1000 บาท
```
...
```text
เพราะบางคนลืมปัดเศษทศนิยม 2 ตำแหน่ง
```
