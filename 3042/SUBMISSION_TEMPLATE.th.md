...
```text
ให้รับ input เป็นเลขจำนวนเต็มและให้ไล่จากจำนวนที่ input เข้ามาจนถึง 0 โดยที่ทุกๆตัวจะห่างกัน 10 และ output เลขออกมาทุกตัวจากมากสุดไปน้อยสุด
```
...
```text
Step 1:สร้างตัวแปรรับ input และสำหรับเก็บทุกๆค่าที่หาร 10 ลงตัว
Step 2:สร้าง loop ไว้หาค่าที่หาร 10 ลงตัวโดยที่เริ่มจากค่า N จนถึง 0 และเก็บเข้าตัวแปรที่สร้างไว้
Step 3:แสดงผล output เรียงจากค่ามากสุดไปน้อยที่สุด
```
...
```text
เพราะว่าบางคนอาจจะไม่เรียงจากค่ามากสุดไปน้อยสุด
```
...
```text
เพราะว่าบางคนอาจจะไม่ได้เพิ่มช่องว่างระหว่างค่าแต่ละค่า
```
...
```text
เพราะว่าบางคนอาจจะไม่ได้ใส่ 0 เข้าไปด้วย
```
