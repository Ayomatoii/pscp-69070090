...
```text
ให้รับ input เป็นคะแนนรวมกับคะแนนสูง และ output ออกมาเป็น Surprising เมื่อคะแนนต่ำสุดกับสูงสุดต่างกันมากกว่า 2 แต้ม หรือ Not surprising เมื่อคะแนนต่ำสุดกับสูงสุดต่างกันไม่เกิน 2 แต้ม
```
...
```text
Step 1:สร้างตัวแปรรับ input
Step 2:ตั้งเงื่อนไขสำหรับและสมการสำหรับคำนวนการว่าค่าสูงสุดคืออะไร ค่าต่ำสุดคืออะไร และมาหาผลต่างว่าต่างกันเกินหรือน้อยกว่าเท่ากับ 2 แต้ม
Step 3:แสดงผล output
```
...
```text
เหมือนกับแผนแรกแต่ว่าตอนทำไม่สามารถเขียนออกมาได้ถูกต้อง ซึ่งผิดตั้งแต่การใช้ % เพราะทำให้การคำนวนไม่ถูกต้อง 100% โดยเฉพาะกับทศนิยม
```
...
```text
เพราะว่าบางคนอาจจะพลาดไม่ได้ตั้งเงื่อนไขสำหรับกรณีที่ค่าของคะแนนสูงสุดที่ * 2 จะเกินคะแนนสูงสุด เพราะไม่งั้นค่าต่ำสุดหรือค่าตัวที่สามจะติดลบ
```
...
```text
เพราะว่าบางคนอาจจะพลาดใช้ % หรือ // และ ZeroDivisionError
```
