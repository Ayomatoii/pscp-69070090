...
```text
ให้รับ input เป็นช่วงจำนวนโดย a ถึง b และให้หาจำนวนที่หารด้วย b เหลือเศษ r ลงตัว และ output ออกมาว่ามีเท่าไหร่
```
...
```text
Step 1:สร้างตัวแปรรับ input a, b, d, r
Step 2:สร้าง loop ไว้หาตัวที่หาร d แล้วได้เศษ r ในช่วง a ถึง b
Step 3:แสดงผล output จำนวนที่หาได้ทั้งหมด
```
...
```text
เพราะว่าบางคนอาจจะลืม + 1 ใน loop
```
...
```text
เพราะว่าบางคนตั้งเงื่อนไขการหารเป็น i % (d + r)
```
...
```text
เพราะว่าบางคนอาจจะตั้ง total = 1
```
