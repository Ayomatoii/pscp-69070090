...
```text
ให้รับ input เป็นแม่สีสองสี และใช้คำสั่ง if เพื่อตั้งเงื่อนไข ถ้าหากเป็นแม่สีทั้งสองสีให้แสดงผลออกมาเป็นสีที่ผสมกัน หากเป็นสีเดียวกันให้แสดงผลออกมาเป็นสีเดิม และหากไม่ใช่มีสีให้แสดงผลออกมาเป็น Error
```
