...
```text
ให้รับ input เป็นเดือนกับวันและให้ output ออกมาเป็น ฤดูตามเงื่อนไขของโจทย์
```
...
Step 2:ตั้งเงื่อนไขสำหรับการแบ่งฤดู
...
```text
เพราะว่าบางคนอาจจะพลาดไม่ได้ตั้งเงื่อนไขวันที่เปลี่ยนฤดู
```
...
```text
เพราะว่าบางคนอาจจะพลาดตั้งเงื่อนไขเป็น d > 21
```
...
```text
เพราะว่าบางคนอาจจะลืมตั้งเงื่อนไขสำหรับเดือนที่ 12 วันที่ 21
```
