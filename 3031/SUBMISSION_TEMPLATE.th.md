...
```text
ให้รับ input เป็นพื้นที่ที่น้ำหมึกขยายออกทุกๆ 1 วิ และจำนวนคำร้องของคน พร้อมกับให้รับ input ตำแหน่งบ้านของแต่ละคนตามจำนวนของคำร้องของคน
และให้ไปเข้านวนว่าบ้านของแต่ละคนจะจมน้ำหมึกในวินาทีที่เท่าไหร่แบบปัดเศษขึ้น และ output ออกมา
```
...
```text
Step 1:สร้างตัวแปร input เป็น .splite()
Step 2:แยก input เป็นสองตัวคือค่าของน้ำหมึกที่จะกระจายทุกๆ 1 วิกับจำนวนคำขอ
Step 3:นำจำนวนคำขอมาเข้า loop เพื่อ input ตำแหน่งของแต่ละคำขอ
Step 4:ใน loop จะนำตำแหน่งของบ้านของแต่ละคนมาคำนวนในสูตร พื้นที่/ความเร็วของน้ำหมึก เพื่อหาเวลา
Step 5: output ออกมา
```
...
```text
เหมือนกับแผนแรกเพราะว่ามันผ่าน
```
