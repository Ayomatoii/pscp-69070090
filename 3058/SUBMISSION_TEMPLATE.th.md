...
```text
ให้รับ input เป็นเลขจำนวนเต็ม 3 ค่าคือ อิฐเล็ก อิฐใหญ่และความยาวสะพาน และเอาไปคิดออกมาว่าต้องใช้อิฐเล็กเท่าไหร่และ output ออกมา ถ้าอิฐเล็กไม่พอให้ output ออกมาเป็น -1
```
...
```text
Step 1:สร้างตัวแปรรับ input สามค่า
Step 2:สร้าง loop และตั้งเงื่อนไขเพื่อคิดหาค่าของอิฐก้อนเล็ก
Step 3:แสดงผล output ของอิฐเล็กออกมา
```
...
```text
เปลี่ยนจากการใช้ลิปในการหาค่าของความยาวสะพานลบด้วยจำนวนอิฐใหญ่ด้วย loop เป็นการใช้ min แทน
```
...
```text
เพราะว่าบางคนอาจจะเอาความยาวสะพานลบด้วยความยาวของอิฐก่อนใหญ่ทั้งหมดตรงๆเลย
```
...
```text
เพราะว่าบางคนอาจจะใช้ลูปในการหาความยาวสะพานลบด้วยความยาวของอิฐก่อนใหญ่
```
...
```text
เพราะว่าบางคนอาจจะไม่ทำเงื่อนไขสำหรับในกรณีที่สะพานสั้นกว่าความยาวของอิฐก้อนใหญ่ทั้งหมด 2 ก้อนขึ้นไป
```
