...
```text
ให้รับ input เป็นเลขจำนวนเต็มและให้หาว่าเลขตัวนี้ต้องพังกำแพงน้อยที่สุดกี่อันถึงจะไปถึงเลข 1 ได้ และ output ออกมาเป็นจำนวนกำแพง
```
...
Step 2:สร้าง loop ไว้คำนวนว่าเลขที่ input มาอยู่แถวที่เท่าไหร่ เพื่อมาเช็คในเงื่อนไขว่าต้องพังกำแพงน้อยสุดกี่อัน
...
```text
เพราะว่าบางคนอาจจะสร้างเงื่อนไขตรงๆและทำถึงแค่ 25
```
...
```text
เพราะว่าบางคนอาจจะพลาดไม่ได้เขียนเงื่อนไขสำหรับแต่ละตัวเลขในแถวเพราะแต่ละตัวก็ต้องพังกำแพงไม่เท่ากัน
```
...
```text
เพราะว่าบางคนอาจจะไม่ได้เขียนให้ขึ้นแถวถัดไป
```
