...
```text
ให้รับ input เป็นตัวอักษาและให้หาว่าในตัวอักษรนี้มีสระ (a, e, i, o, u) กี่ตัว และ output ออกมา ถ้าสระตัวไหนไม่มีไม่ต้อง output
```
...
```text
Step 1:สร้างตัวแปรรับ input และสร้างตัวแปรสำหรับการนับสระ
Step 2:สร้าง loop เพื่อเช็คว่าในคำนี้มีสระอะไรบ้างและมีกี่ตัว
Step 3:แสดงผล output ว่ามีสระตัวไหนบ้างและมีกี่ตัว ถ้าหากสระตัวไหนไม่มีในคำเลยก็ไม่ต้องแสดง
```
...
```text
เพราะว่าบางคนอาจจะลืมเรื่องตัวเล็กตัวใหญ่
```
...
```text
เพราะว่าบางคนอาจจะไม่ได้ทำเงื่อนไขสำหรับสระซ้ำกันหลายตัว
```
...
```text
เพราะว่าบางคนอาจจะเขียนเงื่อนไขสำหรับสระไม่ครบ
```
